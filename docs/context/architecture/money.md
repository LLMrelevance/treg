...
use the documented $0.00178 estimate. Upstream automatically returns risky credits for eligible
accounts; if the platform account loses eligibility due to upstream misuse rules, treg absorbs
