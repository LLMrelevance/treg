...
| [Endpoint catalog — what you can DO with a connected key, and which provider should do it](architecture/catalog.md) | shipped | trykitt.yaml, trykitt.people.email.find.json, trykitt.people.email.verify.json, contracts.yaml, … |
