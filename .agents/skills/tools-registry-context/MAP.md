...
| `src/treg/catalog/examples/trykitt.account.auth.json` | architecture/catalog.md |
| `src/treg/catalog/examples/trykitt.account.credit.json` | architecture/catalog.md |
