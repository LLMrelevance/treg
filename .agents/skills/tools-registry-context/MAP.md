...
| `src/treg/alembic/versions/0027_enrich_arena.py` | interface/enrich-arena.md |
...
| `src/treg/alembic/versions/0030_enrich_arena.py` | architecture/data-model.md |
