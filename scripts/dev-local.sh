...
SERVER_ENV="TREG_EMAIL_DEV_MODE=true TREG_FRONTEND_DEV=true TREG_PUBLIC_URL=http://localhost:$PORT TREG_CONNECT_DEMO_ENABLED=true TREG_DATABASE_URL=sqlite+aiosqlite:///$DEV_DB"
