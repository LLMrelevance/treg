...
# own account" pattern. Extends the PR #511 cohort (google-search-console, google-analytics, semrush).
_MCP_INTENT_PROVIDERS = {
    "google-search-console", "google-analytics", "semrush",  # PR #511 original cohort
    "snapchat-ads", "pinterest-ads", "meta-ads", "tiktok-ads", "facebook",  # ads/social platforms
}
